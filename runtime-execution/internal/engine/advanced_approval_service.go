...
// 编译时接口断言
var _ api.AdvancedApprovalService = (*advancedApprovalService)(nil)

// advancedApprovalService 高级审批业务服务实现
type advancedApprovalService struct {
	repo api.AdvancedApprovalRepository
}

// NewAdvancedApprovalService 创建高级审批服务
func NewAdvancedApprovalService(repo api.AdvancedApprovalRepository) api.AdvancedApprovalService {
