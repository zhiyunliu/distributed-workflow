...
**核心技术栈**：Go 1.21+ / glue(github.com/zhiyunliu/glue) /  sqlserver + Vue 3 / Vite / TypeScript / Element Plus
...
## 3. 后端 Go 开发规范
### 3.1 基础规范
- 使用 **Go 1.21+** 语法，遵循官方 Go Code Review Comments
- 包名使用**小写、简短、有意义**的单词
- 错误必须显式处理，**禁止忽略 error**
- 结构体必须写 JSON 标签
