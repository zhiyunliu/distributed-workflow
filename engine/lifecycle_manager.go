...
type lifecycleManagerImpl struct {
	...
	stateRepo interfaces.InstanceStateService
}

// NewLifecycleManager 创建生命周期管理器
func NewLifecycleManager(repo interfaces.WorkflowRepository, stateRepo interfaces.InstanceStateService) interfaces.LifecycleManager {
