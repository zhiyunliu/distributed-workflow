...
// 编译时接口断言
var _ interfaces.PluginService = (*pluginService)(nil)
...
func NewPluginService(repo interfaces.PluginRepository, registry *plugin.PluginRegistry) interfaces.PluginService {
