...
// New 创建 NodeWorker
func New(cfg Config, container interfaces.NodeExecutorContainer) (*NodeWorker, error) {
...
func (w *NodeWorker) RegisterExecutor(executor interfaces.NodeExecutor) error {
